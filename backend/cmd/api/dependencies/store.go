...
func NewFakeDumplingsStore() (dumplings.Store, error) {
	packs := []dumplings.Product{
		...
		},
		{
			...
			Price:       2.75,
			Image:       "https://storage.yandexcloud.net/momo-store-zateevant/momos/8b50f76f514a4ccaaacdcb832a1b3a2f.jpg",
		},
		{
			ID:          4,
			Name:        "Буузы",
			...
			Price:       4.00,
			Image:       "https://storage.yandexcloud.net/momo-store-zateevant/momos/788c073d83c14b3fa00675306dfb32b5.jpg",
		},
		{
			ID:          5,
			Name:        "Цзяоцзы",
			...
			Price:       7.25,
			Image:       "https://storage.yandexcloud.net/momo-store-zateevant/momos/32cc88a33c3243a6a8838c034878c564.jpg",
		},
		{
			ID:          6,
			Name:        "Гедза",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/momo-store-zateevant/momos/7685ad7e9e634a58a4c29120ac5a5ee1.jpg",
		},
		{
			ID:          7,
			Name:        "Дим-самы",
			Description: "С уткой",
			Price:       2.65,
			Image:       "https://storage.yandexcloud.net/momo-store-zateevant/momos/4bdaeab0ee1842dc888d87d4a435afdd.jpg",
		},
		{
			ID:          8,
			Name:        "Момо",
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/momo-store-zateevant/momos/f64dcea998e34278a0006e0a2b104710.jpg",
		},
		{
			ID:          9,
			Name:        "Вонтоны",
